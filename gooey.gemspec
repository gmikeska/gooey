...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{A component library for rails.}
  spec.description   = %q{A library to implement reusable HTML components}
  spec.homepage      = "https://github.com/gmikeska/gooey"
  spec.license       = "MIT"

  # Prevent pushing this gem to RubyGems.org. To allow pushes either set the 'allowed_push_host'
  # to allow pushing to a single host or delete this component to allow pushing to any host.
